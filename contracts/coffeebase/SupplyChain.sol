...
contract SupplyChain is Ownable, FarmerRole, DistributorRole, RetailerRole, ConsumerRole {
  ...
  struct Item {
    ...
    address ownerID;  // Metamask-Ethereum address of the current contractOwner as the product moves through 8 stages
  ...
  // In the constructor set 'contractOwner' to the address that instantiated the contract
  // and set 'sku' to 1
  // and set 'upc' to 1
  ...
  function harvestItem(uint _upc, address _originFarmerID, string _originFarmName, string _originFarmInformation, string  _originFarmLatitude, string  _originFarmLongitude, string  _productNotes) verifyCaller(_originFarmerID) onlyFarmer public 
  {
